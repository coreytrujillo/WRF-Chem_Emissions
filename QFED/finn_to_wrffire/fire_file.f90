...
wrf_spc_loop : &
            do n = 1,n_wrf_spc
              ...
              do k = 1,wrf2fire_type(n)%fire_cnt
                wrk_sum = wrk_sum + fire_emissions(wrf2fire_type(n)%fire_ndx(k,domain),m) &
...
!---------------------------------------------------------------------
   ...
   message = 'write_fire_file_global_attributes: Failed to put map_proj'
   call handle_ncerr( nf_put_att_int( ncid, nf_global, 'MAP_PROJ', nf_int, 1, proj%code ), message )
   message = 'write_fire_file_global_attributes: Failed to put cen_lon'
   call handle_ncerr( nf_put_att_real( ncid, nf_global, 'CEN_LON', nf_float, 1, proj%lon1 ), message )
   message = 'write_fire_file_global_attributes: Failed to put cen_lat'
   call handle_ncerr( nf_put_att_real( ncid, nf_global, 'CEN_LAT', nf_float, 1, proj%lat1 ), message )
   message = 'write_fire_file_global_attributes: Failed to put stand_lon'
   call handle_ncerr( nf_put_att_real( ncid, nf_global, 'STAND_LON', nf_float, 1, proj%stdlon ), message )
   message = 'write_fire_file_global_attributes: Failed to put truelat1'
   call handle_ncerr( nf_put_att_real( ncid, nf_global, 'TRUELAT1', nf_float, 1, proj%truelat1 ), message )
   message = 'write_fire_file_global_attributes: Failed to put truelat2'
   call handle_ncerr( nf_put_att_real( ncid, nf_global, 'TRUELAT2', nf_float, 1, proj%truelat2 ), message )
   message = 'write_fire_file_global_attributes: Failed to put dx'
   call handle_ncerr( nf_put_att_real( ncid, nf_global, 'DX', nf_float, 1, proj%dx ), message )
   message = 'write_fire_file_global_attributes: Failed to put dy'
   call handle_ncerr( nf_put_att_real( ncid, nf_global, 'DY', nf_float, 1, proj%dy ), message )
   message = 'write_fire_file_global_attributes: Failed to put MMINLU'
   call handle_ncerr( nf_put_att_text( ncid, nf_global, 'MMINLU', 4, 'USGS' ), message )
